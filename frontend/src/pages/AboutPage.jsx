    ...
    <Layout>
      ...
      <div className="relative py-24 bg-navy-800 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="/camp.png" alt="" className="w-full h-full object-cover" />
        </div>
      ...
      <Reveal as="section" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="section-subtitle mb-1">Our Founder</p>
            <p className="text-crimson-500 font-heading font-semibold uppercase tracking-widest text-sm mb-2">Founder &amp; Lead Mentor</p>
